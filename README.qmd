...
To use the RMS:
 ...
 2. assemble the hardware as shown in figure @fig-assembly
 3. configure settings as described in section @sec-configDescription
 3. upload the platformIO project to the board. Once uploaded, the device will automatically start. 

![RMS assembly diagram](./readme_misc/230809_Annotated_V1_2.png "Title: assembly diagram"){width=50% fig-alt="RMS assembly schematic" #fig-assembly}
...
If the device is used for the first time, make sure the device is connected to a PC. This will help for debugging potential wrong settings. 
...
Alternatively, if you can easily upload the RMS_V1.CFG file to the SD card before the first run. RMS_V1.CFG can be found in the "misc" folder.
